...
const definitions: MessageDefinitions = {
  [Locale.EnglishUS]: message`
    ...
    ${quote(`If this keeps failing, you can check the bot's current network and setup status using ${inlineCode('/{{statusCommand}}')}.`)}
  `,
  [Locale.German]: message`
    ...
    ${quote(`Wenn das Problem weiter besteht, kannst du den Netzwerk- und Setup-Status des Bots mit ${inlineCode('/{{statusCommand}}')} checken.`)}
  `,
};
